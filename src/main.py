...
def main():
    ...
    # One‑shot example that includes the square root function
    example = """User: What is the square root of 25?
JSON: {"name": "fn_get_square_root", "parameters": {"a": 25}}"""
...
JSON: {{"name": """
        ...
        if not json_str:
            ...
            full_text2 = '{"name": ' + output2
            json_str = extract_json(full_text2)
